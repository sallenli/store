 ...
 * 提交订单库存更新组件
 */
public class SubmitStockUpdater extends AbstractGoodsStockUpdateCommand {
    /**
     * 订单条条目dto集合
     */
     ...
     * @param dateProvider
     */
    public SubmitStockUpdater(List<GoodsStockDo> goodsStockDos, GoodsStockDao goodsStockDao, DateProvider dateProvider,Map<Long, OrderItemDto> orderItemDtoMap) {
