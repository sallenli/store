 ...
 */
@Component
public class SubmitOrderStockUpdaterFactory <T> extends  AbstractGoodsStockUpdateCommandFactory<T>{

    private static final Logger logger = LoggerFactory.getLogger(SubmitOrderStockUpdaterFactory.class);
    /**
    ...
    protected List<Long> getGoodsSkuIds(T obj) throws Exception {
        try {
            ...
            logger.error("SubmitOrderStockUpdaterFactory.getGoodsSkuIds",e.getMessage());
            return null;
        }
    }
    ...
    protected GoodsStockUpdateCommand create(List<GoodsStockDo> goodsStockDos, T obj) throws Exception {
        try {
            ...
            return new SubmitStockUpdater(goodsStockDos,goodsStockDao,dateProvider,orderItemDtoMap);
        } catch (Exception e) {
            logger.error("SubmitOrderStockUpdaterFactory.create",e.getMessage());
            return null;
        }
    }
}
