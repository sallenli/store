 ...
 */
@Component
    public class CancelOrderStockUpdaterFactory <T> extends  AbstractGoodsStockUpdateCommandFactory<T>{

    private static final Logger logger = LoggerFactory.getLogger(CancelOrderStockUpdaterFactory.class);
    /**
     * @param goodsStockDao 商品库存管理模块的dao组件
     * @param dateProvider
     */
    public CancelOrderStockUpdaterFactory(GoodsStockDao goodsStockDao, DateProvider dateProvider) {
    ...
    protected GoodsStockUpdateCommand create(List<GoodsStockDo> goodsStockDos, T obj) throws Exception {
        try {
            ...
            return new CancelOrderStockUpdater(goodsStockDos,goodsStockDao,dateProvider,orderItemDtoMap);
        } catch (Exception e) {
