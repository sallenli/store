...
public class PayOrderStockUpdater extends AbstractGoodsStockUpdateCommand {
    /**
     * 订单条条目dto集合
     */
     ...
     * @param dateProvider
     */
    public PayOrderStockUpdater(List<GoodsStockDo> goodsStockDos, GoodsStockDao goodsStockDao, DateProvider dateProvider,Map<Long, OrderItemDto> orderItemDtoMap) {
